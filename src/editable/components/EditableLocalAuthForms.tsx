...
const inputClass = 'h-[3.25rem] rounded-md border border-white/10 bg-white/5 px-4 text-base font-bold text-white outline-none transition placeholder:text-white/38 focus:border-[var(--slot4-accent)]'
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center rounded-md bg-[var(--slot4-accent-fill)] px-6 text-xs font-black uppercase tracking-[0.16em] text-white transition hover:-translate-y-0.5 hover:bg-emerald-400 disabled:opacity-60'
